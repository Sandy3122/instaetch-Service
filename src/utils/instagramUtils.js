...
//   async launchOrReuseBrowser() {
//     if (!this.browser || this.requestCount >= this.maxRequestsBeforeRotation) {
//       if (this.browser) {
//         console.log("🔁 Rotating browser (and proxy) after max requests...");
...
//       this.requestCount = 0; // Reset after relaunch
//     }
...
//   // Getting video and image from carousel
//   // async clickAndScrapeCarousel(page) {
//   //   const nextButtonSelector = 'button[aria-label="Next"]';
//   //   const listSelector = "ul._acay";
//   //   const collectedMedia = new Map();
...
//   //       console.log(`[🎥 Intercepted Carousel Video]: ${url}`);
...
//   //       // Try clicking video if exists
//   //       const videoEl = page.locator("ul._acay video");
//   //       if (await videoEl.isVisible({ timeout: 1000 }).catch(() => false)) {
//   //         const playBtn = page.locator('div[role="button"][aria-label*="Play"]');
...
//   //       // Attach intercepted video to current media
//   //       if (intercepted.length) {
//   //         const last = intercepted.pop(); // take latest
//   //         if (last && !collectedMedia.has(last)) {
//   //           collectedMedia.set(last, { type: "video", url: last });
//   //         }
//   //       }
...
//   //     } catch (err) {
//   //       console.log("Reached end of carousel or navigation stopped.");
//   //       break;
//   //     }
//   //   }
  
//   //   console.log(`🎯 Total media items scraped: ${collectedMedia.size}`);
//   //   return Array.from(collectedMedia.values());
//   // }
...
//     try {
//       const context = await this.launchOrReuseBrowser(); // Use shared rotating browser
...
//       try {
//         await page.goto(url, 
//           { waitUntil: "domcontentloaded", timeout: config.instagram.timeout, });
//       } catch (e) {
//         console.warn("First attempt failed. Retrying in 2s...");
//         await page.waitForTimeout(2000);
